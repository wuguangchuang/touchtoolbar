...
//            picker.color = Qt.hsla(picker.hue, picker.saturation, picker.lightness, 1)
    ...
    property int showHeight: 24
    property int showWidth: 128
    Row {
        x: 0 - colorRect.x// - 2 / 2 + 2
        spacing: 2 / 2 + 2
        QtControls.Label {
        ...
        Rectangle {
            ...
            MouseArea {
                anchors.fill: parent
                onClicked: {
                    pickerRow.height = (pickerRow.height == 0 ? pickerRow.implicitHeight : 0)
                    itemClick();
                }
            }
        }
